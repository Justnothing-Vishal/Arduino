...
void loop()
{
    ...
    if (Firebase.ready() && (millis() - dataMillis > 60000 || dataMillis == 0))
    {
        ...
        query.set("select/fields/[0]/123456", "College_ID");
        query.set("select/fields/[1]/fieldPath", "Name");
...
*/
        ...
        if (Firebase.Firestore.runQuery(&fbdo, FIREBASE_PROJECT_ID, "" /* databaseId can be (default) or empty */, "Primary_ID" /* The document path */, &query /* The FirebaseJson object holds the StructuredQuery data */))
            Serial.printf("ok\n%s\n\n", fbdo.payload().c_str());
        else
